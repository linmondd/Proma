...
- **Remote bots**: WeChat bot bridging is supported for triggering local Agent workflows from mobile.
...
6. Configure memory, web search, or the WeChat bridge from their corresponding settings tabs if needed.
...
- `wechat-bridge.ts`: WeChat remote bot bridge.
